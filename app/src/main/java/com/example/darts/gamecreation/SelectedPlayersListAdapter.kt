...
class SelectedPlayersListAdapter(private var selectedPlayers: List<com.example.darts.gamescreen.Player>): RecyclerView.Adapter<SelectedPlayersListAdapter.MyViewHolder>() {
